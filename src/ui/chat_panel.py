...
class ChatMessage(ctk.CTkFrame):
    """Matrix-styled chat message bubble with copy button"""
    ...
    def __init__(self, parent, role: str, content: str, **kwargs):
        ...
        # Content - parse markdown for assistant messages
...
{DECORATIONS['h_line'] * 40}
    ...
    def _update_token_count(self):
        ...
        self.token_count.configure(text=f"~{estimated_tokens} tokens")
